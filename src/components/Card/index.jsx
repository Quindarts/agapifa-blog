...
function Card(props) {
  ...
  const { id, title, 
    ...
    author, updatedAt } = props;
  const date = dayjs(updatedAt).locale('vi').format("DD MMM YYYY");
  const navigate = useNavigate()
  return (
    <button onClick={()=>navigate(`${id}/detail`)} key={id} className="card">
      <div className="card-image">
      <img src="https://cdn.prod.website-files.com/5ee12d8d7f840543bde883de/5ef3a1148ac97166a06253c1_flutter-logo-white-inset.svg"  alt="Flutter" />
      </div>
