  ...
  return (
    <>
      <div className="detail-page">
        ...
        <p className="detail-page__meta">Admin - ngày 03 tháng 11 năm 2024</p>
        ...
        <div className="detail-page__description">
          <p>
            When I am working on Flutter with form. For ensuring data integrity,
            and handling user input errors. I want to show an error message
            below each TextField, Dropdown, Switch, ... if the user does not
            input or wrong input. The EzValidator helps me to resolve this
            issue.
          </p>
          <p>
            In this article, we will explore how to validate user inputs in
            Flutter with the EzValidator package.
          </p>
          <div className="detail-page__contents">
            <span className="detail-page__contents-title">Contents</span>
            <ol className="detail-page__contents-list">
              <li className="detail-page__contents-item">Prerequisites</li>
              <li className="detail-page__contents-item">Implementation</li>
              <li className="detail-page__contents-item">Demo</li>
            </ol>
          </div>
          <p className="detail-page__section-title">
            Prerequisites <br />
            Ensure the VSCode and Flutter are installed on your local. If not
            installed yet, you should follow up with the steps below.
          </p>
          <ul className="detail-page__steps-list">
            ...
            <li className="detail-page__steps-item">
              Set up the VSCode editor to complete, deploy, and debug the app{" "}
              <a href="#">here</a>
            </li>
          </ul>
        </div>
